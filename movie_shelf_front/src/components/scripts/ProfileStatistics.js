        ...
        <div className={styles.stats_body}>
            <div className={styles.stats_box}>
                ...
                <div className={styles.stats_data}>
                    <StatisticsData title="Movies/TV Shows completed" value={completed} style={{"background-color": "#0D5462"}}></StatisticsData>
                    <StatisticsData title="Reviews" value={reviews} style={{"background-color": "#0D6122"}}></StatisticsData>
                    <StatisticsData title="Average Rating" value={average_ratings} style={{"background-color": "#61440D"}}></StatisticsData>
                </div>
            </div>
        </div>
    );
